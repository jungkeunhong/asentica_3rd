      ...
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-4 py-2">
        <div className="flex items-center gap-2 mb-2">
          ...
          <button
            ...
            className="cormorant ml-auto text-sm font-medium text-black hover:text-amber-900 pr-4"
          >
            {showMap ? 'List' : 'Map'}
          </button>
        </div>
          ...
          <div className="grid grid-cols-1 gap-4">
            {loading ? (
              ...
              Array.from({ length: 5 }).map((_, index) => (
                <div key={index} className="animate-pulse bg-gray-100 rounded-lg p-12 h-48"></div>
              ))
