...
export default function DynamicMap({ medspas, onMedspaSelect }: DynamicMapProps) {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      {userLocation && (
        <Button
          className="absolute bottom-116 right-4 bg-white text-black hover:bg-gray-100 shadow-md rounded-full w-10 h-10 p-0 flex items-center justify-center z-10"
