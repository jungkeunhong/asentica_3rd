    ...
    <div className="py-2 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-left">    
          <p className="cormorant mt-2 text-lgg leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
            Learn more
          </p>
        </div>
        <div className="mt-8">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {treatments.map((treatment) => (
              ...
              >
                ...
                <h3 className="mt-4 text-lg font-semibold text-gray-900">{treatment.title}</h3>
