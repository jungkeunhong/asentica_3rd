  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
      <div className="bg-white rounded-lg p-6 w-full max-w-md mx-4 relative">
        ...
        <h2 className="text-2xl font-bold text-center text-[#14517c] mb-6">
          Continue with
        </h2>
        ...
        <form onSubmit={handleLogin} className="mb-4">
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 bg-[#14517c] text-white rounded-full font-medium hover:bg-[#0d3c5d] transition-all duration-300"
            disabled={loading}
          >
        ...
        <div className="mt-4 text-center">
          ...
          <button className="text-[#14517c] underline text-sm">
            Terms
          </button>
        ...
        <div className="mt-4 text-center">
          <button
            ...
            className="text-[#14517c] hover:underline"
          >
