        ...
        <div className="modal-box bg-white rounded-2xl shadow-xl p-6 max-w-md mx-auto">
          ...
          <div className="py-4">
            {isSuccess ? (
              ...
              <>
                <h3 className="font-bold text-lg text-amber-900 mb-2">Request Consultation</h3>
                    ...
                    <>
                      <div className="form-control">
                        ...
                        <input
                          ...
                          className="input input-bordered w-full focus:border-amber-900 bg-white text-gray-900"
                          required
