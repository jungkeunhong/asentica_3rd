...
const CategoryGrid = () => {
  ...
  return (
    <div className="py-4">
      <h2 className="cormorant text-xl font-semibold mb-4 text-gray-900 pl-2">Just choose treatment,<br />We match the best medspa</h2>
      <div className="overflow-x-auto pb-4 hide-scrollbar">
        <div className="grid grid-rows-3 auto-cols-max grid-flow-col gap-y-5">
          {categories.map((category) => (
            ...
            >
              <div className="w-12 h-12 flex items-center justify-center bg-gray-100 rounded-full hover:bg-gray-200 transition-colors">
