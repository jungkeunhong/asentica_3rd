...
const categories = [
  ...
  { id: 6, name: 'Facial', image: 'facial.png' },
  { id: 7, name: 'Lifting', image: 'lifting.png' },
  { id: 8, name: 'Hair Removal', image: 'hair-removal.png' },
  { id: 9, name: 'Chemical Peel', image: 'chemical-peel.png' },
  { id: 10, name: 'LED Therapy', image: 'led-therapy.png' },
];
...
const CategoryGrid = () => {
  ...
  return (
    <div className="py-4">
      <h2 className="cormorant text-2xl font-extrabold mb-4 text-gray-900 pl-5">Just choose treatment,<br />We match the best medspa</h2>
