                  ...
                  .map((village) => (
                    <div key={village} className="flex items-center justify-between">
                      ...
                      <input
                        ...
                        className="appearance-none w-5 h-5 rounded border-1.5 border-gray-500 bg-white checked:border-amber-900 checked:bg-amber-900 focus:ring-amber-900 focus:ring-2 focus:ring-offset-2"
