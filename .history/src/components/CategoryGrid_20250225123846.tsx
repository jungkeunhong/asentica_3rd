  ...
  return (
    <div className="py-4">
      ...
      <div className="overflow-x-auto pb-4 hide-scrollbar">
        <div className="grid grid-rows-3 auto-cols-max grid-flow-col gap-y-5 pl-2">
          {categories.map((category) => (
            ...
            >
              ...
              <span className="text-[12px] text-gray-700 text-center leading-tight mt-2">{category.name}</span>
            </button>
          ))}
        </div>
      </div>
