      ...
      <div className="relative w-full max-w-lg bg-white rounded-lg shadow-xl max-h-[90vh] overflow-auto">
        ...
        <div className="p-4 space-y-6">
                ...
                {availableVillages.map((village) => (
                  <div key={village} className="flex items-center justify-between">
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className={`w-5 h-5 border-2 border-black rounded bg-white flex items-center justify-center ${filters.villages.includes(village) ? 'bg-white' : 'bg-white'}`}>
                        {filters.villages.includes(village) && (
          ...
          <div className="sticky bottom-0 bg-white border-t p-4">
            <Button 
              onClick={handleApply}
              className="w-full bg-white hover:bg-gray-100 text-blue-500 border border-blue-500 py-2 rounded-lg"
            >
              Show results
            </Button>
          </div>
