    ...
    if (isOpen) {
      const fetchTreatmentOptions = async () => {
        try {
          ...
          if (categoryError || efficacyError) {
            console.error('Error fetching treatment options:', { categoryError, efficacyError });
          ...
          if (uniqueCategories.length === 0 && uniqueEfficacies.length === 0) {
