          ...
          <div className="font-extrabold flex justify-between h-16 items-center">
            ...
            <div className="flex items-center">
              ...
              {loading ? (
                ...
                <Link 
                  href="/my-page" 
                  className="flex items-center gap-2 px-4 py-2 rounded-full hover:bg-gray-100 transition-all duration-300"
                >
                  <Image 
                ...
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 rounded-full hover:bg-gray-100 transition-all duration-300 -ml-4"
                  aria-label="Log in"
                >
                  <LogIn size={24} className="text-gray-600 stroke-width-1 hover:text-black" />
                </button>
              )}
              {/* Menu Button */}
              <button
                onClick={toggleSidebar}
                className="flex items-center px-3 py-2 rounded-full hover:bg-gray-100 transition-all duration-300"
                aria-label="Toggle menu"
              >
                <Menu size={24} className="text-gray-600 stroke-width-1 hover:text-black" />
              </button>
            </div>
          </div>
        </div>
