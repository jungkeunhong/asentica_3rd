      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
        ...
        <div className="space-y-6">
          {userData.glowStats && (
            <GlowStatsDisplay 
              stats={{
                postsCount: userData.glowStats.breakdown.posts || 0,
                reviewsCount: userData.glowStats.breakdown.reviews || 0,
                commentsCount: userData.glowStats.breakdown.comments || 0,
                upvotesReceived: userData.glowStats.breakdown.helpfulVotes || 0,
                savesCount: 0,
                streakDays: 0,
