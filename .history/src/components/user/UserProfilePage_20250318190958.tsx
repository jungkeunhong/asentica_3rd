    ...
    <div className="container mx-auto px-4 py-8">
      <ProfileHeader 
        user={{
          ...
          socialLinks: [],
          skinProfile: {
            skinType: userData.skinProfile?.skinType || 'Not specified',
            skinTone: userData.skinProfile?.skinTone || 'Not specified',
            concerns: userData.skinProfile?.concerns || []
          },
          stats: {
            posts: userData.glowStats?.breakdown.posts || 0,
            reviews: userData.glowStats?.breakdown.reviews || 0,
            comments: userData.glowStats?.breakdown.comments || 0,
            likes: 0,
          ...
          badges: userData.badges.map(badge => ({
            ...badge,
            category: badge.category || 'achievements'
          })),
          recentActivity: {
            posts: [],
            reviews: [],
