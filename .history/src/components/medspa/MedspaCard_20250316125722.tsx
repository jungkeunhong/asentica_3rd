...
interface MedspaCardProps {
  ...
  onConsultationRequest: (medspa: Medspa) => void;
          ...
          <div className="flex justify-between items-center mb-1">
            <div>
              {medspa.free_consultation && medspa.free_consultation.trim() !== '' ? (
                <span className="text-3xl text-left text-amber-900 py-1 text-sm">
                  {medspa.free_consultation}
                </span>
              ) : (
                <span className="text-3xl text-left text-gray-500 py-1 text-sm">
                  Paid Consultation
                </span>
              )}
            </div>
