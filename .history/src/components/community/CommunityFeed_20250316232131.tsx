  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        {/* Tabs */}
        <Tabs defaultValue="trending" onValueChange={handleFeedTypeChange} className="flex-1">
        ...
        <div className="flex gap-2 ml-4">
          ...
          <Button className="bg-amber-900 hover:bg-amber-800 text-white flex items-center gap-2 h-9">
            <PlusCircle size={16} />
