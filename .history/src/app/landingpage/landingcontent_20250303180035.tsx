    ...
    <div className="relative bg-white font-cormorant">
      ...
      <motion.button
        ...
        className={`fixed bottom-8 left-1/2 -translate-x-1/2 
            relative bg-gradient-to-b from-zinc-800 to-black 
            text-white px-6 py-3 rounded-full 
            ...
            before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-b before:from-amber-800/50 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity
