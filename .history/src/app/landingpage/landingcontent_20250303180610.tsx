  ...
  return (
    <div className="relative bg-white font-cormorant">
      ...
      <div className="relative w-full h-[70vh]">
        ...
        {/* Hero Content */}
        <motion.div 
          className="absolute inset-0 z-10 flex flex-col items-center justify-center px-2 text-center"
          style={{ opacity, scale }}
        >
          <h1 className="cormorant text-3xl md:text-6xl font-light text-white mt-6 mb-6 tracking-tight">
