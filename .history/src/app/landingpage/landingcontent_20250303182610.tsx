  ...
  return (
    <div className="relative bg-white font-cormorant">
      ...
      <div className="relative w-full h-[70vh]">
        ...
        {/* Hero Content */}
        <motion.div 
          className="absolute inset-0 z-20 flex flex-col items-center justify-center px-2 text-center translate-y-[-30%]"
          style={{ opacity, scale }}
        >
...
<div className="bg-white flex flex-col justify-center px-6 py-16">
  <div className="max-w-4xl mx-auto">
    <h2 className="cormorant text-3xl md:text-4xl font-light text-zinc-900 mb-12 leading-snug tracking-tight text-center">
      Compare top-rated medspa treatments 
      <br className="hidden md:block" />
      with real prices and verified results
    </h2>
