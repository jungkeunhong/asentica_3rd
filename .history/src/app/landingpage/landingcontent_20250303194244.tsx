    ...
    <div className="relative bg-white font-cormorant">
      ...
      <div className="relative w-full h-[70vh]">
        ...
        >
            ...
            +100 verified MedSpas <br />
            and practitioners in NYC
            </p>
        </motion.div>
        </div>

        {/* Description Section */}
        <div className="bg-white flex flex-col justify-center px-6 py-8">
        ...
        <motion.button
        onClick={handleFindMedspa}
        className={`fixed bottom-8 left-1/2 -translate-x-1/2 bg-gradient-to-b from-zinc-800 to-black text-white px-6 py-3 rounded-full border border-zinc-700 shadow-[inset_1px_1px_2px_rgba(255,255,255,0.2),inset_-2px_-2px_2px_rgba(0,0,0,0.8),4px_4px_20px_rgba(0,0,0,0.5)] hover:shadow-[inset_1px_1px_2px_rgba(255,255,255,0.2),inset_-2px_-2px_2px_rgba(0,0,0,0.8),6px_6px_25px_rgba(0,0,0,0.6)] active:shadow-[inset_-2px_-2px_2px_rgba(255,255,255,0.1),inset_2px_2px_2px_rgba(0,0,0,0.8)] active:translate-y-[0.125rem] transition-all duration-200 flex items-center space-x-2 z-50 before:absolute before:inset-0 before:rounded-full before:bg-gradient-to-b before:from-zinc-800/50 before:to-transparent before:opacity-0 hover:before:opacity-100 before:transition-opacity min-w-[180px] whitespace-nowrap ${isScrolled ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        whileHover={{ scale: 1.02 }}
        whileTap={{ scale: 0.98 }}
        >
        <span className="text-base whitespace-nowrap">Find your match</span>
