    ...
    <div className="relative bg-white font-cormorant">
      ...
      <div className="relative w-full h-[70vh]">
        ...
        <motion.div 
          ...
          style={{ opacity, scale }}
        >
          <h1 className="cormorant text-3xl md:text-6xl font-light text-white mt-20 mb-6 leading-tight">
            Your Skin, Your Match
          </h1>
          <h2 className="system-ui text-base md:text-xl font-light text-white/80 max-w-xl mb-12">
            Stop spending hours researching clinics.<br />
            We&apos;ll find your perfect match.
          </h2>
          <motion.button
            onClick={handleFindMedspa}
            className="bg-black text-white px-6 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
