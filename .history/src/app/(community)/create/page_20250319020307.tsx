...
type PostType = 'poll' | 'prompt' | 'question' | 'review' | 'beforeAfter';
          ...
          <div className="flex overflow-x-auto gap-2 no-scrollbar">
            <Button 
              ...
              className={`rounded-full whitespace-nowrap transition-colors ${
                selectedType === 'poll' ? 'bg-black text-white hover:bg-black/90' : ''
              }`}
            ...
            <Button 
              ...
              size="sm" 
              className={`rounded-full whitespace-nowrap transition-colors ${
                selectedType === 'prompt' ? 'bg-black text-white hover:bg-black/90' : ''
              }`}
