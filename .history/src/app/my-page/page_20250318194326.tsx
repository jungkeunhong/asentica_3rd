...
import { BadgeCheck, Calendar, Edit, MapPin, Share2 } from "lucide-react"
    ...
    <div className="container mx-auto pt-4 px-4 sm:px-6">
      ...
      <div className="relative">
        <div className="h-60 w-full overflow-hidden rounded-lg bg-gray-100">
          ...
          {/* Profile Image positioned on the cover image */}
          ...
          {/* User Actions - positioned on top right of cover */}
        ...
        {/* User Info - Positioned next to profile image */}
        <div className="ml-44 pt-4 mb-6">
          <div>
