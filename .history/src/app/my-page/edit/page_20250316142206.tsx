...
export default function EditProfile() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Also update the profiles table to ensure data consistency
      ...
      if (profileUpdateError) {
        ...
        // Continue anyway since the auth metadata was updated successfully
      }
      
      console.log('Profile update successful');
      
      // Force a refresh of the page data when returning to the my-page
      router.refresh();
      router.push('/my-page');
