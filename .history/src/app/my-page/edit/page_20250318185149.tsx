...
import { UserProfile, UserSkinProfile, UserBadge } from "@/types/user"
import { getMockUserData } from "@/data/mockUserData"
import Link from "next/link"
import { ArrowLeft, Camera, Upload } from "lucide-react"
import Image from "next/image"

// Interface for our saved content items
...
// Interface for our mock user data that might have a different structure than UserProfile
...
export default function EditProfilePage() {
  const [user, setUser] = useState<MockUserData | null>(null)
  ...
  useEffect(() => {
    ...
    const mockUser = getMockUserData() as unknown as MockUserData
    setUser(mockUser)
  ...
  // Handle form input changes for text inputs and textareas
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    const { name, value } = e.target
    setFormData(prev => ({ ...prev, [name]: value }))
  }
  
  // Handle form input changes for select elements
