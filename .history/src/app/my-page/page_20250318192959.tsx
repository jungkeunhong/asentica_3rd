...
import { BadgeCheck, Calendar, Edit, LogOut, MapPin, Settings, Share2 } from "lucide-react"
  ...
  return (
    <div className="container mx-auto py-6 px-4 sm:px-6">
      ...
      <div className="relative">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2" style={{ top: "80%" }}>
        ...
        {/* User Info & Actions - Moved down to accommodate centered profile image */}
        <div className="flex flex-col items-center mt-20 mb-6">
          <div className="text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-y-2 gap-x-4 text-sm text-gray-500 mb-4">
              {user.location && (
            ...
            <div className="flex gap-4 text-sm mb-4 justify-center">
              <div>
            ...
            {user.bio && (
              <p className="text-gray-700 mb-6 max-w-xl mx-auto">{user.bio}</p>
            )}
          </div>
