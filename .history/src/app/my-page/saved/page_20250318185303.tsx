...
import type { SavedContent as SavedContentType } from "@/types/user"
...
// Interface for the mock data we might receive
interface MockSavedContent extends SavedContentType {
  tags?: Tag[];
}
...
export default function SavedContent() {
  ...
  useEffect(() => {
    ...
    const formattedContent = (userData.savedContent || []).map((item: MockSavedContent): SavedContentItem => ({
      id: item.id,
