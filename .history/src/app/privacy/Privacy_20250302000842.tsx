      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="mb-10">
          ...
          <ul className="list-disc pl-8 mb-4 space-y-2">
            <li>Visit our website at https://asentica.com, or any website of ours that links to this Privacy Notice</li>
        ...
        <div id="section14" className="mb-10">
          ...
          <p>
            ...
            <a href="mailto:privacy@asentica.com" className="text-blue-600 ml-1 hover:underline">privacy@asentica.com</a>
          </p>
        </div>
