  ...
  return (
    <div className="max-w-4xl mx-auto pb-20 bg-white">
      ...
      <div className="px-4 mt-8">
        ...
        {/* Recommended Practitioners - Clean Card Style */}
        {recommendedPractitioners.length > 0 && (
          <div className="mt-12 mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {recommendedPractitioners.map((practitioner, index) => (
                <div 
                  key={`practitioner-${index}`}
                  className="bg-[#f8f6f4] rounded-xl p-6 relative overflow-hidden group"
                >
                  <div className="absolute top-4 left-4 text-[120px] font-bold text-[#f0ebe6] leading-none">
                    {index + 1}
                  </div>
                  
                  <div className="relative z-10 mt-4">
                    <div className="inline-block px-3 py-1 bg-white rounded-full text-sm font-medium text-[#b38b75] mb-4">
                      {practitioner.name}
                    </div>
                    
                    <h4 className="text-xl font-semibold text-gray-800 mb-3">{practitioner.name}</h4>
                    
                    <p className="text-sm text-gray-600">{practitioner.reason}</p>
                  </div>
                </div>
              ))}
            </div>
