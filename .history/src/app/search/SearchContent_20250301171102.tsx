                          ...
                          {medspa.yelp_star && medspa.yelp_review && (
                            <div className="flex items-center gap-1">
                              ...
                              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 64 64">
                                <path fill="#D32323" d="M29.3 42.2c-.7-.1-8.9-2.6-8.9-2.6-1.4-.4-2.4-1.6-2.4-3 0-1.1.6-2.1 1.5-2.7l9.9-6.9c1.2-.8 2.8-.5 3.6.7.8 1.2.5 2.8-.7 3.6l-7.7 5.4 6.9 2c1.3.4 2.1 1.8 1.7 3.2-.4 1.3-1.8 2.1-3.2 1.7l-.7-.4zm-3.5-30.9c.7.2 1.1 1.1.9 1.8l-3.1 11.4c-.2.7-1.1 1.1-1.8.9-.7-.2-1.1-1.1-.9-1.8l3.1-11.4c.2-.7 1.1-1.1 1.8-.9zm10.3 43.8c-.3.6-1 .9-1.7.7-.6-.3-.9-1-.7-1.7l3.6-8.3c.3-.6 1-.9 1.7-.7.6.3.9 1 .7 1.7l-3.6 8.3zm8.4-11.5c-.4.6-1.3.7-1.9.2l-7.9-6.2c-.6-.4-.7-1.3-.2-1.9.4-.6 1.3-.7 1.9-.2l7.9 6.2c.6.5.7 1.3.2 1.9zm-2.7-13.9c.7-.1 1.4.4 1.5 1.1.1.7-.4 1.4-1.1 1.5l-9.8 1.6c-.7.1-1.4-.4-1.5-1.1-.1-.7.4-1.4 1.1-1.5l9.8-1.6z"/>
                              </svg>
                              <FilledStar className="w-4 h-4 fill-current text-black" />
