...
export default function SearchContent({
  ...
  const formatPriceDisplay = (priceData: PriceData | string) => {
    ...
    const standardPrice = `$${priceData.standard_price} per ${priceData.standard_unit.toLowerCase()}`;

    
    // Check if member price exists
    if (priceData.member_price) {
      const memberPrice = `$${priceData.member_price} ${priceData.member_unit.toLowerCase()}`;
