                  ...
                  >
                    ...
                    <div className="mt-2 flex flex-col sm:flex-row gap-3">
                      <button 
                        ...
                        className="btn bg-amber-800 hover:bg-amber-900 text-white border-none hover:shadow-lg transform flex items-center justify-center gap-2"
                      >
                        <Phone size={16} />
                      </button>
                      <button 
                        onClick={(e) => handleOpenModal(medspa, e)}
                        className="btn bg-amber-100 hover:bg-amber-200 border-none text-amber-800 hover:shadow-lg transform flex items-center justify-center gap-2"
                    ...
                    <div className="mt-2 flex flex-row gap-3">
                      ...
                      <button 
                        onClick={(e) => handleOpenModal(medspa, e)}
                        className="btn bg-amber-100 hover:bg-amber-200 border-none text-amber-800 hover:shadow-lg transform flex items-center justify-center gap-2 flex-1"
                      >
                        <span>Get Consultation</span>
                      </button>
                    </div>
