                  ...
                  >
                    ...
                    <div className="mt-2 flex flex-row gap-3">
                      ...
                      <button 
                        ...
                        className="btn bg-white hover:bg-amber-800 border border-amber-800 text-amber-800 hover:shadow-lg transform flex items-center justify-center gap-2 flex-1"
                      >
