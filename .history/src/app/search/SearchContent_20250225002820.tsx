              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-semibold">
                    {medspa.medspa_name} {medspa.village && `| ${medspa.village}`}
                  </h3>
                  ...
                  <div className="flex items-center gap-4 mt-2">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{medspa.google_star || 'N/A'}</span>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{medspa.yelp_star || 'N/A'}</span>
                  ...
                  <div className="mt-2 space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm text-gray-800">{medspa.good_review_short || "No positive reviews"}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <Minus className="w-4 h-4 text-red-500" />
                      <span className="text-sm text-gray-800">{medspa.bad_review_short || "No negative reviews"}</span>
                    </div>
                  </div>
