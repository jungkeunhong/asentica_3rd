                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                      <button 
                        ...
                        className="btn bg-amber-800 hover:bg-amber-900 text-white border-none hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200 flex items-center justify-center gap-2"
                        style={{ 
                      ...
                      <button 
                        ...
                        className="btn bg-white hover:bg-gray-50 text-amber-800 border-2 border-amber-800 hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200 flex items-center justify-center gap-2"
                        style={{ 
                          borderRadius: '0.75rem',
                        }}
                      >
