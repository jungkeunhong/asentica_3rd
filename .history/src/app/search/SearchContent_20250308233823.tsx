                      ...
                      <span className="text-2xl font-bold text-black">
                        {searchQuery && (() => {
                          ...
                          if (typeof priceData === 'object') {
                            return (
                              <>
                                {searchQuery} - ${priceData.standard_price} {priceData.standard_unit}
                                {priceData.standard_price_note && <span className="text-sm ml-1">({priceData.standard_price_note})</span>}
                                {priceData.member_price && (
                                  <div className="text-sm text-green-600 mt-1">
                                    Member: ${priceData.member_price} {priceData.member_unit}
                                    {priceData.member_price_note && <span className="ml-1">({priceData.member_price_note})</span>}
                                  </div>
                                )}
                              </>
                            );
