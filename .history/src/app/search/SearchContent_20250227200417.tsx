...
export default function SearchContent({ initialMedspas, searchQuery, error }: SearchContentProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Form submitted:', formData, 'for medspa:', selectedMedspa?.medspa_name);
  ...
  const openConsultationModal = (medspa: Medspa) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 flex flex-col sm:flex-row gap-3">
                    ...
                    <button 
                      onClick={() => openConsultationModal(medspa)}
...
const ConsultationModal = () => {
  ...
  return (
    <dialog id="consultation_modal" className={`modal ${isModalOpen ? 'modal-open' : ''}`}>
      <div className="modal-box bg-white rounded-2xl shadow-xl p-6 max-w-md mx-auto">
        ...
        <p className="text-sm text-gray-600 mb-4">
          {selectedMedspa?.medspa_name ? `Complete the form below to request a consultation with ${selectedMedspa.medspa_name}` : 'Complete the form below to request a consultation'}
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="form-control">
            ...
            <input 
              ...
              className="input input-bordered w-full focus:border-amber-800" 
              required 
            />
          </div>
          ...
          <div className="form-control">
            ...
            <textarea 
              ...
              onChange={handleInputChange}
              className="textarea textarea-bordered h-24 focus:border-amber-800" 
