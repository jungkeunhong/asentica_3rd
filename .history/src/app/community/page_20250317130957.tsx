      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              Connect with fellow skincare enthusiasts
            </p>
          </div>
          <CreatePostButton />
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
          ...
          <div className="flex flex-wrap gap-2">
            <div className="relative">
              ...
              >
                <TagsIcon size={14} />
                {selectedTag ? `#${selectedTag}` : "Browse Topics"}
                {selectedTag && (
                  <span 
                ...
                <div className="absolute z-10 mt-1 w-56 rounded-md bg-popover shadow-lg border border-border">
                  <div className="p-2 max-h-64 overflow-y-auto">
                    ...
                    <div className="mt-2 pt-2 border-t border-border">
                      <Link href="/community/tags" className="text-xs text-primary hover:underline">
                        View all topics
                      </Link>
                    </div>
                  </div>
        ...
        <div className="mt-12">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/community/tags" className="text-primary text-sm hover:underline">
              View all
            </Link>
          </div>
